...
use App\Http\Controllers\ArchiveGalleryController;
...
Route::get('/archive', [ArchiveGalleryController::class, 'index'])->name('archive.index');
...
Route::get('/faces', function () {
    $faces = [
        ...
        ['name' => 'Рустембеков Акмурза Исаевич', 'subtitle' => 'Выпускник', 'role' => 'Казахстанский архитектор, Президент Союза архитекторов Республики Казахстан. Автор монумента Астана-Байтерек'],
    ];
